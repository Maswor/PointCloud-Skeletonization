...
// enum TypeId
// {BOOL,INT,FLOAT,STRING,MATRIX44F,POINT3F,COLOR,ENUM,MESH,GROUP,FILENAME};
//
// class Binding
//{
// public:
...
public:
  ...
  ParameterDecoration(Value *defvalue, const QString desc = QString(),
...
public:
  BoolDecoration(BoolValue *defvalue, const QString desc = QString(),
                 const QString tltip = QString());
  ~BoolDecoration() {}
};
...
public:
  IntDecoration(IntValue *defvalue, const QString desc = QString(),
                const QString tltip = QString());
  ~IntDecoration() {}
};
...
public:
  DoubleDecoration(DoubleValue *defvalue, const QString desc = QString(),
                   const QString tltip = QString());
  ~DoubleDecoration() {}
};
...
public:
  StringDecoration(StringValue *defvalue, const QString desc = QString(),
                   const QString tltip = QString());
  ~StringDecoration() {}
};
...
public:
  Matrix44fDecoration(Matrix44fValue *defvalue, const QString desc = QString(),
                      const QString tltip = QString());
  ~Matrix44fDecoration() {}
};
...
public:
  Point3fDecoration(Point3fValue *defvalue, const QString desc = QString(),
                    const QString tltip = QString());
  ~Point3fDecoration() {}
};
...
public:
  ColorDecoration(ColorValue *defvalue, const QString desc = QString(),
                  const QString tltip = QString());
  ~ColorDecoration() {}
};
...
public:
  AbsPercDecoration(AbsPercValue *defvalue, const double minVal,
...
public:
  EnumDecoration(EnumValue *defvalue, QStringList values,
...
public:
  DoubleListDecoration(DoubleListValue *defvalue,
                       const QString desc = QString(),
                       const QString tltip = QString())
...
public:
  DynamicDoubleDecoration(DynamicDoubleValue *defvalue, const double minVal,
                          const double maxVal, const QString desc = QString(),
                          const QString tltip = QString());
...
public:
  SaveFileDecoration(FileValue *defvalue, const QString extension,
                     const QString desc = QString(),
                     const QString tltip = QString());
  ~SaveFileDecoration() {}
...
public:
  OpenFileDecoration(FileValue *directorydefvalue, const QStringList extensions,
                     const QString desc = QString(),
                     const QString tltip = QString());
  ~OpenFileDecoration() {}
...
public:
  ...
  RichBool(const QString nm, const bool defval, const QString desc,
           const QString tltip);
  RichBool(const QString nm, const bool val, const bool defval,
...
public:
  RichInt(const QString nm, const int defval, const QString desc = QString(),
          const QString tltip = QString());
  RichInt(const QString nm, const int val, const int defval,
...
public:
  RichDouble(const QString nm, const double defval,
             const QString desc = QString(), const QString tltip = QString());
  RichDouble(const QString nm, const double val, const double defval,
             const QString desc = QString(), const QString tltip = QString());
  void accept(Visitor &v);
  bool operator==(const RichParameter &rb);
  ~RichDouble();
...
public:
  RichMatrix44f(const QString nm, const vcg::Matrix44f &defval,
                const QString desc = QString(),
                const QString tltip = QString());
  RichMatrix44f(const QString nm, const vcg::Matrix44f &val,
                const vcg::Matrix44f &defval, const QString desc = QString(),
                const QString tltip = QString());
  void accept(Visitor &v);
  bool operator==(const RichParameter &rb);
  ~RichMatrix44f();
...
public:
  RichPoint3f(const QString nm, const vcg::Point3f defval,
              const QString desc = QString(), const QString tltip = QString());
  RichPoint3f(const QString nm, const vcg::Point3f val,
              const vcg::Point3f defval, const QString desc = QString(),
              const QString tltip = QString());
  void accept(Visitor &v);
  bool operator==(const RichParameter &rb);
  ~RichPoint3f();
...
public:
  ...
  RichColor(const QString nm, const QColor defval, const QString desc,
            const QString tltip);
  RichColor(const QString nm, const QColor val, const QColor defval,
            const QString desc, const QString tltip);
  void accept(Visitor &v);
  bool operator==(const RichParameter &rb);
  ~RichColor();
...
public:
  RichAbsPerc(const QString nm, const double defval, const double minval,
              const double maxval, const QString desc = QString(),
              const QString tltip = QString());
  RichAbsPerc(const QString nm, const double val, const double defval,
...
public:
  RichEnum(const QString nm, const int defval, const QStringList values,
           const QString desc = QString(), const QString tltip = QString());
  RichEnum(const QString nm, const int val, const int defval,
...
public:
  RichDoubleList(const QString nm, DoubleListValue *v,
                 DoubleListDecoration *prdec);
  RichDoubleList(const QString nm, DoubleListValue *val, DoubleListValue *v,
                 DoubleListDecoration *prdec);
  void accept(Visitor &v);
  bool operator==(const RichParameter &rb);
  ~RichDoubleList();
...
public:
  RichDynamicDouble(const QString nm, const double defval, const double minval,
                    const double maxval, const QString desc = QString(),
                    const QString tltip = QString());
  RichDynamicDouble(const QString nm, const double val, const double defval,
                    const double minval, const double maxval,
                    const QString desc = QString(),
                    const QString tltip = QString());
  void accept(Visitor &v);
...
public:
  RichOpenFile(const QString nm, const QString directorydefval,
               const QStringList exts, const QString desc = QString(),
               const QString tltip = QString());
  void accept(Visitor &v);
  bool operator==(const RichParameter &rb);
  ~RichOpenFile();
...
public:
  RichSaveFile(const QString nm, const QString filedefval, const QString ext,
               const QString desc = QString(), const QString tltip = QString());
  void accept(Visitor &v);
  bool operator==(const RichParameter &rb);
  ~RichSaveFile();
...
// 	QDomElement parElem;
// private:
// 	void fillRichParameterAttribute(const QString& type,const QString&
// name,const QString& desc,const QString& tooltip);
// 	void fillRichParameterAttribute(const QString& type,const QString&
// name,const QString& val,const QString& desc,const QString& tooltip);
// };
